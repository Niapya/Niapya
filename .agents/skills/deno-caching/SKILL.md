---
name: deno-caching
description: Use when working with Deno Deploy's HTTP caching layer
license: MIT
metadata:
  author: denoland
  version: "1.0"
...
# Deno Deploy CDN and caching

Deno Deploy includes a built-in HTTP caching layer that automatically caches eligible responses at the edge, reducing latency and origin load. This skill covers how caching works, how to control cache behavior, and how to invalidate cached content.
...
The cache follows [RFC 9110](https://httpwg.org/specs/rfc9110.html) and [RFC 9111](https://httpwg.org/specs/rfc9111.html) semantics, implementing standard HTTP caching behavior.

## Cache-Control Headers

Deno Deploy respects the standard `Cache-Control` header.
...
- Source: https://docs.deno.com/deploy/reference/caching/
